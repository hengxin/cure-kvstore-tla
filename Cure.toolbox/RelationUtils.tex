...
\@pvspace{8.0pt}%
 ...
 \.{\defeq}}%
\@y{\@s{0}%
 Does total order \ensuremath{R} (represented as a sequence) respect
 \ensuremath{T}\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} ( T \.{\,|\,} Range
 ( R ) ) \.{\subseteq} SeqToRel ( R )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 27 14:06:50 \ensuremath{CST} 2020 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
