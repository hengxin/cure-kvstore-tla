...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\ASSUME}}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} cvc ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} clock
 ,\,\@s{10.98}}%
\@y{\@s{0}%
 \ensuremath{clock[p][d]}: the current clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} pvc ,\,\@s{18.14}}%
\@y{\@s{0}%
 \ensuremath{pvc[p][d]}: the vector clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} css ,\,\@s{19.42}}%
\@y{\@s{0}%
 \ensuremath{css[p][d]}: the stable snapshot
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} PMC ,\,\@s{8.66}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} updates ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} msgs\@s{4.1}}%
\@y{\@s{0}%
 the set of messages in transit
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} cVars\@s{3.57} \.{\defeq}
 {\langle} cvc {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} sVars\@s{4.08} \.{\defeq}
 {\langle} clock ,\, pvc ,\, css ,\, PMC ,\, store ,\, updates {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} mVars \.{\defeq} {\langle}
 msgs {\rangle}}%
...
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Clock \.{\defeq} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} VC \.{\defeq} [ Datacenter
 \.{\rightarrow} Clock ]\@s{4.1}}%
\@y{\@s{0}%
 vector clock with an entry per datacenter \ensuremath{d \.{\in} Datacenter
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} VCInit \.{\defeq} [ d
 \.{\in} Datacenter \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} KVTuple \.{\defeq} [ key
 \.{:} Key ,\, val \.{:} Value ,\, vc \.{:} VC ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Message\@s{3.08} \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{43.99} [ type \.{:}
 \{\@w{ReadRequest} \} ,\, key \.{:} Key ,\, vc \.{:} VC ,\, c \.{:} Client
 ,\, p \.{:} Partition ,\, d \.{:} Datacenter ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\cup}\@s{16.48}
 [ type \.{:} \{\@w{ReadReply} \} ,\, val \.{:} Value ,\, vc\@s{4.67} \.{:}
 VC ,\, c \.{:} Client ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\cup}\@s{16.48}
...
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} cvc \.{=}
 [ c \.{\in} Client \.{\mapsto} VCInit ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\land} clock
 ...
 \.{\mapsto} VCInit ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land} PMC \.{=}
 [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto} [ q
 \.{\in} Partition \.{\mapsto} VCInit ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} store
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}
 \{ \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} updates
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}
 {\langle} {\rangle} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land} msgs
 \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Max ( a ,\, b ) \.{\defeq}
 {\IF} a \.{<} b \.{\THEN} b \.{\ELSE} a}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Ready2Issue ( c ) \.{\defeq}
 \A\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} m . type \.{\in}
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} Read ( c ,\, k ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{c \.{\in} Client} reads from \ensuremath{k \.{\in} Key
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{22.12} \.{\land}
 Ready2Issue ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{22.12} \.{\land} Send ( [
 type \.{\mapsto}\@w{ReadRequest} ,\, key \.{\mapsto} k ,\, vc \.{\mapsto}
 cvc [ c ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{61.89} c \.{\mapsto} c
 ,\, p \.{\mapsto} KeySharding [ k ] ,\, d \.{\mapsto} ClientAttachment [ c ]
 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{22.12} \.{\land}
 {\UNCHANGED} {\langle} cVars ,\, sVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} ReadReply ( c ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{c \.{\in} Client} handles the reply to its read request
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{16.4} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{31.61} \.{\land} m . type
 \.{=}\@w{ReadReply} \.{\land} m . c \.{=} c\@s{4.1}}%
\@y{\@s{0}%
 such \ensuremath{m} is unique
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{31.61} \.{\land} cvc
 \.{'} \.{=} [ d \.{\in} Datacenter \.{\mapsto} Max ( m . vc [ d ] ,\, cvc [
 d ] ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, mVars {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} Update ( c ,\, k ,\, v )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 Ready2Issue ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\land} Send ( [
 type \.{\mapsto}\@w{UpdateRequest} ,\, key \.{\mapsto} k ,\, val \.{\mapsto}
 v ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{56.16} vc \.{\mapsto} cvc
 [ c ] ,\, c \.{\mapsto} c ,\, p \.{\mapsto} KeySharding [ k ] ,\, d
 \.{\mapsto} ClientAttachment [ c ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} cVars ,\, sVars {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} UpdateReply ( c )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{c \.{\in} Client} handles the reply to its update request
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} \E\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{31.61} \.{\land} m . type
 \.{=}\@w{UpdateReply} \.{\land} m . c \.{=} c}%
\@y{\@s{0}%
 such \ensuremath{m} is unique
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{31.61} \.{\land} cvc
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} UpdateRequest ( p ,\, d )
 \.{\defeq}}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{31.61} \.{\land} m . vc
 [ d ] \.{\leq} clock [ p ] [ d ]\@s{4.1}}%
\@y{\@s{0}%
 waiting condition
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{31.61} \.{\land} pvc
 \.{'} \.{=} [ pvc {\EXCEPT} {\bang} [ p ] [ d ] [ d ] \.{=} clock [ p ] [ d
 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{31.61} \.{\land} css
 \.{'}\@s{1.27} \.{=} [ css {\EXCEPT} {\bang} [ p ] [ d ] \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{46.82} [ dc\@s{0.52}
 \.{\in} Datacenter \.{\mapsto} {\IF} dc \.{=} d \.{\THEN} @ [ dc ] \.{\ELSE}
 Max ( m . vc [ dc ] ,\, @ [ dc ] ) ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{31.61} \.{\land}
 \.{\LET} kv \.{\defeq} [ key \.{\mapsto} m . key ,\, val \.{\mapsto} m . val
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{99.16} vc\@s{1.07}
 \.{\mapsto} [ m . vc {\EXCEPT} {\bang} [ d ] \.{=} clock [ p ] [ d ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{42.72} \.{\IN} \.{\land}
 store \.{'} \.{=} [ store {\EXCEPT} {\bang} [ p ] [ d ]\@s{2.22} \.{=} @
 \.{\cup} \{ kv \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{63.12} \.{\land} updates
 \.{'} \.{=} [ updates {\EXCEPT} {\bang} [ p ] [ d ] \.{=} @ \.{\circ}
 {\langle} kv {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{63.12} \.{\land} Send (
 [ type \.{\mapsto}\@w{UpdateReply} ,\, ts \.{\mapsto} clock [ p ] [ d ] ,\,
 c \.{\mapsto} m . c ,\, d \.{\mapsto} d ] )}%
...
\@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client ,\, k \.{\in} Key \.{:} Read ( c ,\, k )}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client ,\, k \.{\in} Key ,\, v \.{\in} Value \.{:} Update
 ( c ,\, k ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client \.{:} ReadReply ( c ) \.{\lor} UpdateReply ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{16.4} \.{\lor} \E\, p
 \.{\in} Partition ,\, d \.{\in} Datacenter \.{:} UpdateRequest ( p ,\, d )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}}\midbar\@xx{}%
