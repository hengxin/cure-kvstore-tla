...
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Key ,\,\@s{34.69}}%
\@y{\@s{0}%
 the set of keys, ranged over by \ensuremath{k \.{\in} Key
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Value
 ,\,\@s{27.66}}%
\@y{\@s{0}%
 the set of values, ranged over by \ensuremath{v \.{\in} Value
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Client
 ,\,\@s{25.44}}%
\@y{\@s{0}%
 the set of clients, ranged over by \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} Partition
 ,\,\@s{12.33}}%
\@y{\@s{0}%
 the set of partitions, ranged over by \ensuremath{p \.{\in} Partition
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} Datacenter
 ,\,\@s{4.09}}%
\@y{\@s{0}%
 the set of datacenters, ranged over by \ensuremath{d \.{\in} Datacenter
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} KeySharding
 ,\,\@s{20.5}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} NotVal \.{\defeq} {\CHOOSE}
 v \.{:} v \.{\notin} Value}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} cvc ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} clock
 ,\,\@s{10.98}}%
\@y{\@s{0}%
 \ensuremath{clock[p][d]}: the current clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} pvc ,\,\@s{18.14}}%
\@y{\@s{0}%
 \ensuremath{pvc[p][d]}: the vector clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} css ,\,\@s{19.42}}%
\@y{\@s{0}%
 \ensuremath{css[p][d]}: the stable snapshot
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} PMC ,\,\@s{8.66}}%
\@y{\@s{0}%
 \ensuremath{PMC[p][d]}: matrix clock
}%
\@xx{}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} updates ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} msgs\@s{4.1}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 {\langle} clock ,\, pvc ,\, css ,\, PMC ,\, store ,\, updates {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} mVars \.{\defeq} {\langle}
 msgs {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} vars \.{\defeq} {\langle}
 cvc ,\, clock ,\, pvc ,\, css ,\, PMC ,\, store ,\, updates ,\, msgs
 {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} Clock \.{\defeq} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} VC \.{\defeq} [ Datacenter
 \.{\rightarrow} Clock ]\@s{4.1}}%
\@y{\@s{0}%
 vector clock with an entry per datacenter \ensuremath{d \.{\in} Datacenter
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} VCInit \.{\defeq} [ d
 \.{\in} Datacenter \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} KVTuple \.{\defeq} [ key
 \.{:} Key ,\, val \.{:} Value \.{\cup} \{ NotVal \} ,\, vc \.{:} VC ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Message\@s{3.08} \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{43.99} [ type \.{:}
 \{\@w{ReadRequest} \} ,\, key \.{:} Key ,\, vc \.{:} VC ,\, c \.{:} Client
 ,\, p \.{:} Partition ,\, d \.{:} Datacenter ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\cup}\@s{16.48}
 [ type \.{:} \{\@w{ReadReply} \} ,\, val \.{:} Value \.{\cup} \{ NotVal \}
 ,\, vc \.{:} VC ,\, c \.{:} Client ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\cup}\@s{16.48}
...
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 pvc\@s{9.48} \.{\in} [ Partition \.{\rightarrow} [ Datacenter
 \.{\rightarrow} VC ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 css\@s{10.75} \.{\in} [ Partition \.{\rightarrow} [ Datacenter
 \.{\rightarrow} VC ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 PMC \.{\in} [ Partition \.{\rightarrow} [ Datacenter \.{\rightarrow} [
 Partition \.{\rightarrow} VC ] ] ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} cvc \.{=}
 [ c \.{\in} Client \.{\mapsto} VCInit ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} clock
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto} 0
 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land}
 pvc\@s{9.48} \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter
 \.{\mapsto} VCInit ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land}
 css\@s{10.75} \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter
 \.{\mapsto} VCInit ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} PMC \.{=}
 [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto} [ q
 \.{\in} Partition \.{\mapsto} VCInit ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land} store
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{79.14} [ key \.{:} \{ k
 \.{\in} Key \.{:} KeySharding [ k ] \.{=} p \} ,\, val \.{:} \{ NotVal \}
 ,\, vc \.{:} \{ VCInit \} ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \.{\land} updates
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}
 {\langle} {\rangle} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\land} msgs
 \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} Max ( a ,\, b ) \.{\defeq}
...
\@pvspace{8.0pt}%
 ...
 dm \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} Ready2Issue ( c ) \.{\defeq}
 \A\, m \.{\in} msgs \.{:}}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{22.12} \.{\land}
 Ready2Issue ( c )}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{46.82} [ dc \.{\in}
 Datacenter \.{\mapsto} {\IF} dc \.{=} d \.{\THEN} @ [ dc ] \.{\ELSE} Max ( m
 . vc [ dc ] ,\, @ [ dc ] ) ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{31.61} \.{\land}
 \.{\LET} kvs \.{\defeq} \{ kv \.{\in} store [ p ] [ d ] \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{105.22} \.{\land} kv .
 key \.{=} m . key}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{105.22} \.{\land} \A\,
 dc \.{\in} Datacenter \.{\,\backslash\,} \{ d \} \.{:} kv . vc [ dc ]
 \.{\leq} css \.{'} [ p ] [ d ] [ dc ] \}}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{63.12} lkv\@s{1.27}
 \.{\defeq} {\CHOOSE} kv \.{\in} kvs \.{:}\@s{4.1}}%
\@y{\@s{0}%
 choose the latest one (Existence\.{?} Uniqueness\.{?})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{104.32} \A\, akv \.{\in}
 kvs ,\, dc \.{\in} Datacenter \.{:} akv . vc [ dc ] \.{\leq} kv . vc [ dc ]}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{42.72} \.{\IN}
 ...
 {\UNCHANGED} {\langle} cVars ,\, clock ,\, pvc ,\, PMC ,\, store ,\, updates
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} UpdateRequest ( p ,\, d )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{31.61} \.{\land} m . vc
 [ d ] \.{\leq} clock [ p ] [ d ]\@s{4.1}}%
\@y{\@s{0}%
 waiting condition
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{31.61} \.{\land} pvc
 \.{'} \.{=} [ pvc {\EXCEPT} {\bang} [ p ] [ d ] [ d ] \.{=} clock [ p ] [ d
 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{31.61} \.{\land} css
 \.{'}\@s{1.27} \.{=} [ css {\EXCEPT} {\bang} [ p ] [ d ] \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{46.82} [ dc\@s{0.52}
 \.{\in} Datacenter \.{\mapsto} {\IF} dc \.{=} d \.{\THEN} @ [ dc ] \.{\ELSE}
 Max ( m . vc [ dc ] ,\, @ [ dc ] ) ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{31.61} \.{\land}
 \.{\LET} kv \.{\defeq} [ key \.{\mapsto} m . key ,\, val \.{\mapsto} m . val
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{99.16} vc\@s{1.07}
 ...
 \.{\cup} \{ kv \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{63.12} \.{\land} updates
 \.{'} \.{=} [ updates {\EXCEPT} {\bang} [ p ] [ d ] \.{=} @ \.{\circ}
 {\langle} kv {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{63.12} \.{\land}
 ...
 {\UNCHANGED} {\langle} cVars ,\, clock ,\, PMC {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client ,\, k \.{\in} Key \.{:} Read ( c ,\, k )}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client ,\, k \.{\in} Key ,\, v \.{\in} Value \.{:} Update
 ( c ,\, k ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{16.4} \.{\lor} \E\,
 c\@s{0.57} \.{\in} Client \.{:} ReadReply ( c ) \.{\lor} UpdateReply ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{16.4} \.{\lor} \E\, p
 \.{\in} Partition ,\, d \.{\in} Datacenter \.{:} ReadRequest ( p ,\, d )
 \.{\lor} UpdateRequest ( p ,\, d )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}} Spec \.{\defeq} Init
