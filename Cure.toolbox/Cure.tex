...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} Sharding\@s{19.99}}%
\@y{\@s{0}%
 the mapping from \ensuremath{Key} to \ensuremath{Partition
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\ASSUME} Sharding \.{\in} [
 Key \.{\rightarrow} Partition ]}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} cvc ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} clock ,\,\@s{8.97}}%
\@y{\@s{0}%
 \ensuremath{clock[p][d]}: the current clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} pvc ,\,\@s{16.13}}%
\@y{\@s{0}%
 \ensuremath{pvc[p][d]}: the vector clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} css ,\,\@s{17.41}}%
\@y{\@s{0}%
 \ensuremath{css[p][d]}: the stable snapshot
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} PMC ,\,\@s{6.65}}%
\@y{\@s{0}%
 \ensuremath{PMC[p][d]}: matrix clock
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} store ,\,\@s{9.43}}%
\@y{\@s{0}%
 \ensuremath{store[p][d]}: the kv store
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} updates\@s{4.09}}%
\@y{\@s{0}%
 \ensuremath{updates[p][d]}: the buffer of updates
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} vars \.{\defeq} {\langle}
 cvc ,\, clock ,\, pvc ,\, css ,\, PMC ,\, store ,\, updates {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Clock \.{\defeq} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} VC \.{\defeq} [ Datacenter
 \.{\rightarrow} Clock ]\@s{4.1}}%
\@y{\@s{0}%
 vector clock with an entry per datacenter \ensuremath{d \.{\in} Datacenter
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} VCInit \.{\defeq} [ d
 \.{\in} Datacenter \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} KVTuple \.{\defeq} [ key
 \.{:} Key ,\, val \.{:} Value ,\, vc \.{:} VC ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} TypeOK \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} cvc \.{=}
 [ c \.{\in} Client \.{\mapsto} VCInit ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} clock
 ...
 \.{\mapsto} VCInit ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land} PMC \.{=}
 [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto} [ q
 \.{\in} Partition \.{\mapsto} VCInit ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} store
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}
 \{ \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} updates
 \.{=} [ p \.{\in} Partition \.{\mapsto} [ d \.{\in} Datacenter \.{\mapsto}
 {\langle} {\rangle} ] ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\lor}
 {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Spec \.{\defeq} Init
